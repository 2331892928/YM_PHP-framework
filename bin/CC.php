...
class CC{
     ...
     */
    public function __construct($model = 1,$second = 120,$frequency = 600,$blockingTime = 300,$ip_model = 3,$whetherToOpen = true){
        $this->model = $model;
        $this->second = $second;
...
str;
        return str_ireplace(['{ip}'], [$this->ipV2($this->ip_model)], $html);
    }
    /**
     * 获取ipv2自定义版
